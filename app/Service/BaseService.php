...
class BaseService implements BaseContract
{
    ...
    public function all(bool $paginate = false, int|null $page = 1, int $dataPerPage = 10, array $relations = [], array $whereConditions = [], string|null $guard = null, string|null $foreignKey = null)
    {
        try {
            ...
            if ($paginate) {
                $model = $query->latest()->paginate(10, ["*"], "page", $page)->withQueryString();
